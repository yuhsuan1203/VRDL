...
dataset_base = Config({
    ...
    'train_info':   './data/train_set.json',

    # Validation images and annotations.
    'valid_images': './data/train_images',
    'valid_info':   './data/valid_set.json',
...
yolact_resnet101_pascal_config = yolact_resnet101_config.copy({
    'name': None, # Will default to yolact_resnet101_pascal
    ...
    'backbone': yolact_resnet101_config.backbone.copy({
        'pred_scales': [[32], [64], [128], [256], [512]],
        'use_square_anchors': False,
    })
})
